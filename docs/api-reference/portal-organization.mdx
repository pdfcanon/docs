...
```
GET https://api.pdfcanon.io/api/portal/organization
...
```bash
curl https://api.pdfcanon.io/api/portal/organization \
...
```javascript
const response = await fetch('https://api.pdfcanon.io/api/portal/organization', {
...
resp = httpx.get(
    "https://api.pdfcanon.io/api/portal/organization",
...
```
PUT https://api.pdfcanon.io/api/portal/organization
Authorization: Bearer <access_token>
...
```bash
curl -X PUT https://api.pdfcanon.io/api/portal/organization \
  -H "Authorization: Bearer eyJ..." \
...
```
PUT https://api.pdfcanon.io/api/portal/organization/settings
Authorization: Bearer <access_token>
Content-Type: application/json
```
...
```bash
curl -X PUT https://api.pdfcanon.io/api/portal/organization/settings \
  -H "Authorization: Bearer eyJ..." \
  -H "Content-Type: application/json" \
  -d '{
...
```javascript
const response = await fetch('https://api.pdfcanon.io/api/portal/organization/settings', {
  method: 'PUT',
  headers: {
    Authorization: `Bearer ${accessToken}`,
    'Content-Type': 'application/json',
...
```
POST https://api.pdfcanon.io/api/portal/organization/deactivate
Authorization: Bearer <access_token>
```
...
```bash
curl -X POST https://api.pdfcanon.io/api/portal/organization/deactivate \
  -H "Authorization: Bearer eyJ..."
```
