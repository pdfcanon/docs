...
```
POST https://api.pdfcanon.io/api/auth/register
...
```bash
curl -X POST https://api.pdfcanon.io/api/auth/register \
...
```javascript
const response = await fetch('https://api.pdfcanon.io/api/auth/register', {
  method: 'POST',
...
resp = httpx.post(
    "https://api.pdfcanon.io/api/auth/register",
    json={
        "orgName": "Acme Corp",
        "orgSlug": "acme",
        "ownerEmail": "admin@acme.com",
...
```
POST https://api.pdfcanon.io/api/auth/login
Content-Type: application/json
```
...
```javascript
const response = await fetch('https://api.pdfcanon.io/api/auth/login', {
  method: 'POST',
  headers: { 'Content-Type': 'application/json' },
  credentials: 'include',
...
resp = client.post(
    "https://api.pdfcanon.io/api/auth/login",
...
```
POST https://api.pdfcanon.io/api/auth/refresh
```
...
```bash
curl -X POST https://api.pdfcanon.io/api/auth/refresh \
  -b cookies.txt \
  -c cookies.txt
```
...
```javascript
const response = await fetch('https://api.pdfcanon.io/api/auth/refresh', {
  method: 'POST',
  credentials: 'include',
});
...
```
POST https://api.pdfcanon.io/api/auth/logout
...
```bash
curl -X POST https://api.pdfcanon.io/api/auth/logout \
...
```javascript
await fetch('https://api.pdfcanon.io/api/auth/logout', {
  method: 'POST',
...
```
POST https://api.pdfcanon.io/api/auth/forgot-password
Content-Type: application/json
```
...
```bash
curl -X POST https://api.pdfcanon.io/api/auth/forgot-password \
  -H "Content-Type: application/json" \
...
```javascript
await fetch('https://api.pdfcanon.io/api/auth/forgot-password', {
  method: 'POST',
  headers: { 'Content-Type': 'application/json' },
...
```python
httpx.post(
    "https://api.pdfcanon.io/api/auth/forgot-password",
...
```
POST https://api.pdfcanon.io/api/auth/reset-password
Content-Type: application/json
```
...
```bash
curl -X POST https://api.pdfcanon.io/api/auth/reset-password \
  -H "Content-Type: application/json" \
  -d '{
...
```javascript
const response = await fetch('https://api.pdfcanon.io/api/auth/reset-password', {
  method: 'POST',
  headers: { 'Content-Type': 'application/json' },
  body: JSON.stringify({
    token: 'abc123resettoken',
...
```python
resp = httpx.post(
    "https://api.pdfcanon.io/api/auth/reset-password",
