...
For programmatic, server-to-server access to PDF processing endpoints (`/api/normalize`, etc.), use **API keys** - not JWT. See [API Keys](/api-reference/portal-api-keys).
